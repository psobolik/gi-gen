...
pub(super) const FOCUSED_TITLE_STYLE: Style = Style::new().fg(Color::Yellow).bg(Color::LightBlue);
pub(super) const DEFAULT_BLOCK_STYLE: Style = Style::new().fg(Color::DarkGray).bg(Color::Black);
pub(super) const DEFAULT_TITLE_STYLE: Style = Style::new().fg(Color::DarkGray).bg(Color::Black);
pub(super) const TASK_BAR_STYLE: Style = Style::new().fg(Color::Yellow).bg(Color::LightBlue);
